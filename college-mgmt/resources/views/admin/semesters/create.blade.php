        ...
        <form method="POST" action="{{ route('admin.semesters.store') }}">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <input aria-label="Semester name" type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Semester 5 (2025-26)" required>
                ...
                <div class="col-md-4">
                    ...
                    <input aria-label="Number" type="number" name="number" class="form-control" value="{{ old('number', 1) }}" min="1" max="12" required>

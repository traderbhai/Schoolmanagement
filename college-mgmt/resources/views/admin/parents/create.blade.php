        ...
        <form method="POST" action="{{ route('admin.parents.store') }}">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input aria-label="Password" type="password" name="password" class="form-control @error('password') is-invalid @enderror" required>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <select aria-label="Relation" name="relation" class="form-select @error('relation') is-invalid @enderror" required>
                ...
                <div class="col-md-4">
                    ...
                    <input aria-label="Occupation" type="text" name="occupation" class="form-control" value="{{ old('occupation') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Annual Income</label>
                    <input aria-label="Annual Income" type="text" name="annual_income" class="form-control" value="{{ old('annual_income') }}">
                </div>
                <div class="col-12">

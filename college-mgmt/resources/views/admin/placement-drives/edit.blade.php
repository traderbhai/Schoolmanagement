    ...
    <div class="col-lg-9">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ route('admin.placement-drives.update', $placementDrive) }}">
                    @csrf @method('PUT')
                    @php $drive = $placementDrive; @endphp
                    @include('admin.placement-drives._form')
                    <div class="d-flex gap-2 mt-4">
                        <button class="btn btn-primary">Update Drive</button>

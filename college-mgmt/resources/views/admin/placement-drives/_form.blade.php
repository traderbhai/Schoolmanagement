<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="package" class="form-control @error('package') is-invalid @enderror"
    ...
    <div class="col-md-4">
        ...
        <input type="date" name="drive_date" class="form-control @error('drive_date') is-invalid @enderror"
    ...
    <div class="col-md-4">
        ...
        <input type="date" name="last_apply_date" class="form-control @error('last_apply_date') is-invalid @enderror"
    ...
    <div class="col-md-4">
        ...
        <input type="number" name="min_cgpa" step="0.01" min="0" max="10" class="form-control @error('min_cgpa') is-invalid @enderror"
            value="{{ old('min_cgpa', $drive->min_cgpa ?? '') }}">
        @error('min_cgpa')<div class="invalid-feedback">{{ $message }}</div>@enderror
    </div>
    <div class="col-md-4">
        <label class="form-label">Vacancies</label>
        <input type="number" name="vacancies" min="1" class="form-control @error('vacancies') is-invalid @enderror"
            value="{{ old('vacancies', $drive->vacancies ?? '') }}">
        @error('vacancies')<div class="invalid-feedback">{{ $message }}</div>@enderror
    </div>
    <div class="col-md-12">
        <label class="form-label">Eligibility Criteria</label>
        <input type="text" name="eligibility" class="form-control @error('eligibility') is-invalid @enderror"
    ...
    <div class="col-md-12">
        ...
        <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3">{{ old('description', $drive->description ?? '') }}</textarea>

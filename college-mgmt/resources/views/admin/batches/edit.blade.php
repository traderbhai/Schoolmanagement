                ...
                <form method="POST" action="{{ route('admin.batches.update', $batch) }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input aria-label="Program name" type="text" class="form-control" value="{{ $batch->program->name ?? '—' }}" disabled>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input aria-label="Start Date" type="date" name="start_date" class="form-control"
                                value="{{ old('start_date', $batch->start_date?->format('Y-m-d')) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">End Date <span class="text-danger">*</span></label>
                            <input aria-label="End Date" type="date" name="end_date" class="form-control"
                        ...
                        <div class="col-12">
                            ...
                            <textarea aria-label="Description" name="description" class="form-control" rows="2">{{ old('description', $batch->description) }}</textarea>
                        </div>
                    </div>

        ...
        <form method="POST" action="{{ route('admin.courses.store') }}">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input aria-label="BTCS" type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="BTCS" required>
                ...
                <div class="col-md-6">
                    ...
                    <input aria-label="Duration Years" type="number" name="duration_years" class="form-control" value="{{ old('duration_years', 4) }}" min="1" max="6" required>
                ...
                <div class="col-md-6">
                    ...
                    <input aria-label="Total Semesters" type="number" name="total_semesters" class="form-control" value="{{ old('total_semesters', 8) }}" min="1" max="12" required>

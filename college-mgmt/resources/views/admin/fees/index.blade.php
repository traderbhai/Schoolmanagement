        ...
        <div class="kpi-card kpi-blue">
            <div class="d-flex align-items-start justify-content-between">
                <div>
                    ...
                    <div class="kpi-value mt-1">₹{{ number_format($totalDue, 2) }}</div>
        ...
        <div class="kpi-card kpi-green">
            <div class="d-flex align-items-start justify-content-between">
                <div>
                    ...
                    <div class="kpi-value mt-1">₹{{ number_format($totalCollected, 2) }}</div>
        ...
        <div class="kpi-card kpi-amber">
            <div class="d-flex align-items-start justify-content-between">
                <div>
                    ...
                    <div class="kpi-value mt-1">₹{{ number_format($totalPending, 2) }}</div>
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <form method="GET" action="{{ route('admin.fees.index') }}" class="d-flex gap-2">
                        <select name="course_id" class="form-select form-select-sm" onchange="this.form.submit()" style="min-width:140px">
            ...
            <div class="card-body p-0">
                <table class="table table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <td class="text-end fw-semibold" style="color:#059669">₹{{ number_format($f->amount, 2) }}</td>
                        <td>
    ...
    <div class="col-lg-4">
        <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.fees.report') }}" class="btn btn-sm btn-outline-secondary">View All</a>
            </div>
            <div class="card-body p-0">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item px-3 py-2">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="text-end">
                                <div class="fw-bold text-success" style="font-size:.88rem">₹{{ number_format($p->amount_paid, 2) }}</div>
                                @if($p->status === 'paid')

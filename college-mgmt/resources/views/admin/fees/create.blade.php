        ...
        <form method="POST" action="{{ route('admin.fees.store') }}">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="fee_type" class="form-control @error('fee_type') is-invalid @enderror" value="{{ old('fee_type') }}" placeholder="Tuition / Exam / Lab…" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="semester_number" class="form-control" value="{{ old('semester_number') }}" placeholder="Leave blank = all" min="1" max="12">

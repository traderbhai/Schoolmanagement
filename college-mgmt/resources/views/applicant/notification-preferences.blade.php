...
<div class="max-w-xl mx-auto py-8 px-4">
    ...
    <form method="POST" action="{{ route('applicant.notifications.update') }}">
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            <p class="text-sm text-gray-600 mb-2">Control which email notifications you receive about your application.</p>

            @foreach([
                'email_application_updates' => 'Application Status Updates',
                'email_payment_updates'     => 'Payment Confirmations & Reminders',
                'email_result_published'    => 'Exam & Selection Results',

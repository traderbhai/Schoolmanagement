...
<head>
    ...
    <title>@yield('title', 'Admission Partner Portal')</title>
...
<div class="offcanvas offcanvas-start sidebar-mobile" tabindex="-1" id="mobileSidebar">
    <div class="offcanvas-header border-bottom">
        <div class="sidebar-brand w-100">
            <span class="brand-icon"><i class="bi bi-building-check"></i></span>
            <span>
    ...
    <div class="offcanvas-body p-0">
        <x-ui.manifest-sidebar
            role="admission_partner"
            brand-sub="Partner Portal"
            brand-icon="bi-building-check"
            :show-brand="false"
            :show-footer="false"
        />
    </div>

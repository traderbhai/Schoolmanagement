...
<head>
    ...
    <style>
        :root { --sidebar-bg:#14532d; --sidebar-active:#166534; --sidebar-text:#86efac; }
        ...
        .sidebar .brand { padding:1.1rem 1.4rem; background:#052e16; color:#f8fafc; font-weight:700; font-size:1.05rem; display:flex; align-items:center; gap:.6rem; }
        ...
        .sidebar .section-label { font-size:.68rem; text-transform:uppercase; letter-spacing:.1em; color:#16a34a; padding:.8rem 1.4rem .2rem; }
        ...
        .day-header { background:#14532d; color:#f8fafc; font-size:.8rem; }
        ...
        @media(max-width:991.98px){
            ...
            .offcanvas-body .section-label{font-size:.68rem;text-transform:uppercase;letter-spacing:.1em;color:#16a34a;padding:.6rem 1rem .1rem;}
        }
...
<div class="offcanvas offcanvas-start sidebar-mobile" tabindex="-1" id="mobileSidebar" aria-labelledby="mobileSidebarLabel" style="background:var(--sidebar-bg);width:270px">
    <div class="offcanvas-header border-bottom border-secondary py-2">
        <span class="text-white fw-bold" id="mobileSidebarLabel"><i class="bi bi-mortarboard-fill me-2"></i>Student Portal</span>

<div class="row g-3">
    ...
    <div class="col-md-2">
        ...
        <input aria-label="Sort Order" type="number" name="sort_order" class="form-control" min="1"
            value="{{ old('sort_order', $parameter?->sort_order ?? $nextOrder ?? 1) }}" required>
    </div>
    <div class="col-md-12">
        <label class="form-label">Description</label>
        <textarea aria-label="What does this parameter evaluate?" name="description" class="form-control" rows="2"

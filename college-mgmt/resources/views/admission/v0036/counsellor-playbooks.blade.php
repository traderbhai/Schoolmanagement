...
<div class="row g-3">
    ...
    <div class="col-lg-4">
        <form method="POST" action="{{ route('admission.counsellor-playbooks.store') }}" class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <input aria-label="Playbook name" class="form-control form-control-sm mb-2" name="name" placeholder="Playbook name" required>
                <select aria-label="Playbook Type" class="form-select form-select-sm mb-2" name="playbook_type">
                ...
                <input aria-label="Counsellor playbook stage" class="form-control form-control-sm mb-2" name="stage" placeholder="Optional stage">

...
<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input aria-label="Total Seats" type="number" name="total_seats" class="form-control" min="1"
    ...
    <div class="col-md-3">
        ...
        <input aria-label="General Seats" type="number" name="general_seats" class="form-control seat-input" min="0" value="{{ old('general_seats', $matrix?->general_seats ?? 0) }}">
    </div>
    <div class="col-md-3">
        <label class="form-label">OBC</label>
        <input aria-label="Obc Seats" type="number" name="obc_seats" class="form-control seat-input" min="0" value="{{ old('obc_seats', $matrix?->obc_seats ?? 0) }}">
    </div>
    <div class="col-md-3">
        <label class="form-label">SC</label>
        <input aria-label="Sc Seats" type="number" name="sc_seats" class="form-control seat-input" min="0" value="{{ old('sc_seats', $matrix?->sc_seats ?? 0) }}">
    </div>
    <div class="col-md-3">
        <label class="form-label">ST</label>
        <input aria-label="St Seats" type="number" name="st_seats" class="form-control seat-input" min="0" value="{{ old('st_seats', $matrix?->st_seats ?? 0) }}">
    </div>
    <div class="col-md-3">
        <label class="form-label">EWS</label>
        <input aria-label="Ews Seats" type="number" name="ews_seats" class="form-control seat-input" min="0" value="{{ old('ews_seats', $matrix?->ews_seats ?? 0) }}">
    </div>
    ...
    <div class="col-md-4">
        ...
        <input aria-label="Management Quota" type="number" name="management_quota" class="form-control seat-input" min="0" value="{{ old('management_quota', $matrix?->management_quota ?? 0) }}">
    </div>
    <div class="col-md-4">
        <label class="form-label">NRI Quota</label>
        <input aria-label="Nri Quota" type="number" name="nri_quota" class="form-control seat-input" min="0" value="{{ old('nri_quota', $matrix?->nri_quota ?? 0) }}">
    </div>
    <div class="col-md-4">
        <label class="form-label">Defence Quota</label>
        <input aria-label="Defence Quota" type="number" name="defence_quota" class="form-control seat-input" min="0" value="{{ old('defence_quota', $matrix?->defence_quota ?? 0) }}">
    </div>

...
<div class="card border-0 shadow-sm">
    <div class="table-responsive">
        <table class="table table-sm align-middle mb-0">
            <thead class="table-light"><tr><th>Date</th><th>Type</th><th>Title</th><th>Status</th><th></th></tr></thead>
            <tbody>
            @foreach($events as $event)
                <tr>
                    ...
                    <td><a class="btn btn-sm btn-outline-primary" href="{{ $event['route'] }}">Open</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>

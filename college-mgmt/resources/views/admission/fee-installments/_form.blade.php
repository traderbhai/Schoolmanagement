<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <input aria-label="Installment Number" type="number" name="installment_number" class="form-control @error('installment_number') is-invalid @enderror"
    ...
    <div class="col-md-6">
        ...
        <div class="input-group">
            ...
            <input aria-label="Amount" type="number" name="amount" class="form-control @error('amount') is-invalid @enderror"
    ...
    <div class="col-md-6">
        ...
        <input aria-label="Due Date" type="date" name="due_date" class="form-control"
    ...
    <div class="col-md-12">
        ...
        <textarea aria-label="Installment notes" name="description" class="form-control" rows="2"

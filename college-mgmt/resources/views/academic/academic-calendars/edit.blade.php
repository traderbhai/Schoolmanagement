            ...
            <form action="{{ route('academic.academic-calendars.update', $academicCalendar) }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="event_name" class="form-control" value="{{ old('event_name', $academicCalendar->event_name) }}" required>
                        @error('event_name')<div class="text-danger small">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Event Date</label>
                        <input type="date" name="event_date" class="form-control" value="{{ old('event_date', $academicCalendar->event_date->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" class="form-control" rows="2">{{ old('description', $academicCalendar->description) }}</textarea>
                    </div>
                    <div class="col-md-6">

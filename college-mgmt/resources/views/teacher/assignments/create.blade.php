                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="datetime-local" name="due_at" value="{{ old('due_at') }}"
                               class="form-control @error('due_at') is-invalid @enderror" required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}"
                               ...
                               placeholder="e.g. Assignment 1 – Linked Lists" required>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="3"
                                  ...
                                  placeholder="Brief overview of the assignment">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" name="allow_late_submission"
                                   ...
                                   onchange="document.getElementById('late-penalty-row').style.display = this.checked ? '' : 'none'">

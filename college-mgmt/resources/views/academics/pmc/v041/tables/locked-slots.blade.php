<div class="card shadow-sm mb-3">
    ...
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th scope="col">Slot</th><th scope="col">Type</th><th scope="col">Day</th><th scope="col">Lock</th><th scope="col">Reason</th></tr></thead><tbody>

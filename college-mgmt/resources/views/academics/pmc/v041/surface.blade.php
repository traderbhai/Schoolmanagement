    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body py-2">
            <form class="row g-2 align-items-end">
                <div class="col-md-2"><label class="form-label small">Search</label><input class="form-control form-control-sm" name="search" value="{{ request('search') }}" placeholder="Student, group, subject, faculty"></div>
                ...
                <div class="col-md-2"><label class="form-label small">Order</label><select class="form-select form-select-sm" name="direction"><option value="asc" @selected(request('direction','asc')==='asc')>Asc</option><option value="desc" @selected(request('direction')==='desc')>Desc</option></select></div>
                <div class="col-md-4 d-flex gap-1"><button class="btn btn-sm btn-primary">Filter</button><a href="{{ url()->current() }}" class="btn btn-sm btn-outline-secondary">Reset</a><a href="{{ route('academics.pmc.v041.surface.export', ['surface' => $surface] + request()->query()) }}" class="btn btn-sm btn-outline-success">Export Current View</a></div>
            </form>
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-header py-2 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="small text-muted">Latest run freshness, unscheduled classes, conflicts, resolution actions, publish checks, and impact-preview readiness.</div>
                    </div>
                ...
                <div class="card-footer py-2 small">{{ $generationDiagnostics['recommended_action'] }}</div>
            </div>
        @endisset
        <div class="row g-3">
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-header py-2 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="small text-muted">Official go-live status across version lifecycle, revision requests, publish checks, notifications, sync, and impact.</div>
                    </div>
                ...
                <div class="card-footer py-2 small">{{ $publishReadinessDiagnostics['recommended_action'] }}</div>
            </div>
        @endisset
        <div class="row g-3">
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-header py-2 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="small text-muted">Today/tomorrow uncovered classes, weak substitute recommendations, same-day changes, repeated substitution risk, and notification readiness.</div>
                    </div>
                ...
                <div class="card-footer py-2 small">{{ $substitutionEmergencyDiagnostics['recommended_action'] }}</div>
            </div>
        @endisset
        <div class="row g-3">

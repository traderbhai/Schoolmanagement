...
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        ...
        <div class="btn-group btn-group-sm">
            <a href="{{ route('academics.program-leadership.index') }}" class="btn btn-outline-secondary">Program OS</a>
        ...
        <div class="card-header py-2">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div>
                    ...
                    <span class="small text-muted">Scoped, database-backed program records linked to source workflows.</span>
                </div>
            ...
            <form method="GET" action="{{ request()->url() }}" class="row g-2 align-items-end mt-2">
                <div class="col-12 col-md-5">
                    <label for="program-leadership-search" class="form-label small text-muted mb-1">Search</label>
                    <input id="program-leadership-search" type="search" name="search" value="{{ $filters['search'] ?? '' }}" class="form-control form-control-sm" placeholder="Search record, status, or program">
                </div>
                <div class="col-12 col-md-4">
                    <label for="program-leadership-status" class="form-label small text-muted mb-1">Status</label>
                    <select id="program-leadership-status" name="status" class="form-select form-select-sm">
            ...
            <div class="small text-muted mt-2">Visible filter summary: {{ $section['filter_summary'] ?? 'Showing all scoped program leadership records.' }}</div>
        </div>

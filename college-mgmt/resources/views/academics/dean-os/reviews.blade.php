        ...
        <div class="col-xl-5">
            <form method="POST" action="{{ route('academics.dean-os.reviews.store') }}" class="card shadow-sm">@csrf
                ...
                <div class="card-body row g-2">
                    ...
                    <div class="col-12 text-end"><button class="btn btn-sm btn-primary">Create Meeting</button></div>
                </div>
            </form>
        </div>
        <div class="col-xl-7">
            <form method="POST" action="{{ route('academics.dean-os.actions.store') }}" class="card shadow-sm">@csrf
                ...
                <div class="card-body row g-2">
                    ...
                    <div class="col-12 text-end"><button class="btn btn-sm btn-primary">Create Action</button></div>
                </div>
            </form>
        </div>
    </div>
    <div class="card shadow-sm mb-3">
        <div class="card-header py-2 fw-semibold">Action Tracker</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('academics.dean-os.actions.update', $action) }}" class="d-flex gap-1">@csrf @method('PATCH')
                                ...
                                <input name="closure_note" class="form-control form-control-sm" placeholder="Closure note">

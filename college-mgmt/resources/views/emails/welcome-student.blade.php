      ...
      <tr><td style="padding:40px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:6px;overflow:hidden;margin-bottom:24px;">
          <tr style="background:#f9fafb;">
            ...
            <td style="padding:12px 16px;font-size:14px;color:#111827;font-weight:bold;">{{ $student->enrollment_number }}</td>
          </tr>
          <tr>
            <td style="padding:12px 16px;font-size:14px;color:#6b7280;border-top:1px solid #e5e7eb;">Login Email</td>
            <td style="padding:12px 16px;font-size:14px;color:#111827;border-top:1px solid #e5e7eb;">{{ $student->user->email }}</td>
          </tr>
          <tr style="background:#f9fafb;">

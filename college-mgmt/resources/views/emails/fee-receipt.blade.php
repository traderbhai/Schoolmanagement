  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:40px;">
        <p style="margin:0 0 16px;font-size:16px;color:#374151;">Dear <strong>{{ $payment->student->user->name }}</strong>,</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:6px;overflow:hidden;margin-bottom:24px;">
          <tr style="background:#f9fafb;">
            ...
            <td style="padding:12px 16px;font-size:14px;color:#111827;font-weight:bold;">{{ $payment->receipt_number }}</td>
          </tr>
          <tr>
            <td style="padding:12px 16px;font-size:14px;color:#6b7280;border-top:1px solid #e5e7eb;">Fee Type</td>
            <td style="padding:12px 16px;font-size:14px;color:#111827;border-top:1px solid #e5e7eb;">{{ $payment->feeStructure->fee_type }}</td>
          </tr>
          <tr style="background:#f9fafb;">
            <td style="padding:12px 16px;font-size:14px;color:#6b7280;border-top:1px solid #e5e7eb;">Amount Paid</td>
            <td style="padding:12px 16px;font-size:14px;color:#111827;font-weight:bold;border-top:1px solid #e5e7eb;">&#8377;{{ number_format($payment->amount_paid, 2) }}</td>
          </tr>
          <tr>
            <td style="padding:12px 16px;font-size:14px;color:#6b7280;border-top:1px solid #e5e7eb;">Payment Date</td>
            <td style="padding:12px 16px;font-size:14px;color:#111827;border-top:1px solid #e5e7eb;">{{ $payment->payment_date->format('d M Y') }}</td>
          </tr>
          <tr style="background:#f9fafb;">
            <td style="padding:12px 16px;font-size:14px;color:#6b7280;border-top:1px solid #e5e7eb;">Payment Method</td>
            <td style="padding:12px 16px;font-size:14px;color:#111827;border-top:1px solid #e5e7eb;">{{ ucfirst($payment->payment_method) }}</td>
          </tr>
        </table>

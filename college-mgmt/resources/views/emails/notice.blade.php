<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><title>{{ $notice->title }}</title></head>
  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
      <tr><td style="background:#dc6f00;padding:30px 40px;">
        ...
        <h1 style="margin:0;color:#ffffff;font-size:22px;">{{ $notice->title }}</h1>
      </td></tr>
      <tr><td style="padding:40px;">
        <p style="margin:0 0 8px;font-size:13px;color:#9ca3af;">Published on {{ \Carbon\Carbon::parse($notice->publish_date)->format('d M Y') }}</p>

...
<div class="info-box">
    <p><strong>Receipt Number:</strong> {{ $feePayment->id ?? 'N/A' }}</p>
    <p><strong>Amount Paid:</strong> ₹{{ number_format($feePayment->amount ?? 0, 2) }}</p>
    ...
    <p><strong>Payment Mode:</strong> {{ ucfirst($feePayment->payment_mode ?? 'N/A') }}</p>
</div>

            ...
            <form action="{{ route('cmc.internships.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="role_title" class="form-control @error('role_title') is-invalid @enderror" value="{{ old('role_title') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="stipend" class="form-control @error('stipend') is-invalid @enderror" value="{{ old('stipend') }}" min="0" step="0.01">
                        @error('stipend')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Supervisor Name</label>
                        <input type="text" name="supervisor_name" class="form-control @error('supervisor_name') is-invalid @enderror" value="{{ old('supervisor_name') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="supervisor_email" class="form-control @error('supervisor_email') is-invalid @enderror" value="{{ old('supervisor_email') }}">

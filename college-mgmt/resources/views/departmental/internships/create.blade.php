...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ route('cmc.internships.index') }}" class="btn btn-outline-secondary me-3"><i class="bi bi-arrow-left"></i></a>
        <div>
            <h2 class="mb-0">Register Internship</h2>
            <p class="text-muted mb-0">Add a new internship, industrial training or live project record</p>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cmc.internships.store') }}" method="POST">
                ...
                <div class="row g-3">
                        ...
                        <select name="student_id" class="form-select @error('student_id') is-invalid @enderror" required>
                            ...
                            @foreach ($students as $student)
                                <option value="{{ $student->id }}" @selected(old('student_id') == $student->id)>
                                    {{ $student->user->name }} ({{ $student->enrollment_number ?? 'No enr#' }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Linked Company (optional)</label>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="role_title" class="form-control @error('role_title') is-invalid @enderror"
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Stipend (₹/month)</label>
                        <input type="number" name="stipend" class="form-control @error('stipend') is-invalid @enderror"
                               value="{{ old('stipend') }}" min="0" step="0.01">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="supervisor_email" class="form-control @error('supervisor_email') is-invalid @enderror"

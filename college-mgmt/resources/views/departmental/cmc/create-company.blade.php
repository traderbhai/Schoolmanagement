...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form method="POST" action="{{ route('cmc.companies.store') }}" onsubmit="return confirm('Add this company to the recruiter database? Confirm recruiter identity, contact details, industry, and future drive/application traceability before saving.')">
      @csrf
      <div class="row g-3">
        <div class="col-md-8">
        ...
        <div class="col-md-4">
          ...
          <input aria-label="Company industry" type="text" name="industry" class="form-control" value="{{ old('industry') }}" placeholder="e.g. IT, Finance">
        </div>
        <div class="col-md-6">
          <label class="form-label small fw-semibold">Website</label>
          <input aria-label="Company website URL" type="url" name="website" class="form-control" value="{{ old('website') }}" placeholder="https://...">
        </div>
        <div class="col-md-6">
          <label class="form-label small fw-semibold">Contact Person</label>
          <input aria-label="Contact Person" type="text" name="contact_person" class="form-control" value="{{ old('contact_person') }}">
        </div>
        <div class="col-md-6">
          <label class="form-label small fw-semibold">Contact Email</label>
          <input aria-label="Contact Email" type="email" name="contact_email" class="form-control" value="{{ old('contact_email') }}">
        </div>
        <div class="col-md-6">
          <label class="form-label small fw-semibold">Contact Phone</label>
          <input aria-label="Contact Phone" type="text" name="contact_phone" class="form-control" value="{{ old('contact_phone') }}">
        </div>
        <div class="col-12">

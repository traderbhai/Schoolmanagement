...
class RoleRedirectTest extends TestCase
{
    ...
    public static function roleDashboardProvider(): array
    {
        return [
            ...
            'admission_partner' => ['admission_partner', 'admission.partner-portal.dashboard'],
            'dean_academics' => ['dean_academics', 'academics.dean-os.index'],
            'program_chair' => ['program_chair', 'academics.pmc.command'],
            'hod' => ['hod', 'hod.dashboard'],
            'exam_cell' => ['exam_cell', 'exam-cell.dashboard'],
            'exam_manager' => ['exam_manager', 'academics.coe.index'],
            'exam_officer' => ['exam_officer', 'academics.coe.index'],
            'iqac_head' => ['iqac_head', 'academics.iqac.index'],
            'pmc_manager' => ['pmc_manager', 'academics.pmc.command'],

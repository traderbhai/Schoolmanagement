...
use App\Services\PmcTimetableScopeService;
...
class ArchitectureStabilizationTest extends TestCase
{
    ...
    {
        $budgets = [
            'app/Services/AcademicPmcTimetableV041Service.php' => 1038,
            'app/Services/PmcTimetableAllocationOperationsService.php' => 676,
            ...
            'app/Services/PmcTimetableScopeService.php' => 120,

...
class StudentScholarshipApplication extends Model {
    use HasFactory;
    protected $fillable = ['student_id','scholarship_scheme_id','cgpa_at_application','reason','documents_path','status','reviewed_by','review_note','disbursed_at','disbursed_amount','disbursement_ref'];

...
{
    protected $fillable = ['timetable_entry_id', 'course_group_id', 'original_teacher_id', 'substitute_teacher_id', 'substitution_date', 'status', 'score', 'reasons', 'conflict_checks'];

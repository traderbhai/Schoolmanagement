...
class BookIssue extends Model {
    use HasFactory;
    protected $fillable = ['book_copy_id','student_id','teacher_id','issued_by','issued_at','due_date','returned_at','return_accepted_by','fine_amount','fine_paid','status'];
    protected $casts = ['fine_paid' => 'boolean', 'issued_at' => 'datetime', 'returned_at' => 'datetime', 'due_date' => 'date'];

        ...
        return [
            [
                ...
                'fields' => [
                    ...
                    ['key' => 'category', 'label' => 'Category', 'type' => 'select', 'options' => ['General', 'OBC', 'OBC-NC', 'SC', 'ST', 'EWS', 'PWD', 'NRI', 'Management Quota'], 'required' => true],
                    ['key' => 'pwd_percentage', 'label' => 'Disability Percentage (%)', 'type' => 'number', 'required' => false, 'conditional' => 'category:PWD'],
                    ['key' => 'domicile_state', 'label' => 'Domicile State', 'type' => 'select', 'options' => ['Andhra Pradesh','Arunachal Pradesh','Assam','Bihar','Chhattisgarh','Goa','Gujarat','Haryana','Himachal Pradesh','Jharkhand','Karnataka','Kerala','Madhya Pradesh','Maharashtra','Manipur','Meghalaya','Mizoram','Nagaland','Odisha','Punjab','Rajasthan','Sikkim','Tamil Nadu','Telangana','Tripura','Uttar Pradesh','Uttarakhand','West Bengal','Delhi','Jammu & Kashmir','Ladakh','Andaman & Nicobar Islands','Chandigarh','Dadra & Nagar Haveli','Daman & Diu','Lakshadweep','Puducherry'], 'required' => false],
                    ['key' => 'entrance_exam_type', 'label' => 'Entrance Exam', 'type' => 'select', 'options' => ['CAT', 'MAT', 'XAT', 'CMAT', 'ATMA', 'GMAT', 'Other', 'None'], 'required' => false],
                    ['key' => 'entrance_exam_score', 'label' => 'Percentile / Score', 'type' => 'number', 'required' => false, 'conditional' => 'entrance_exam_type:not:None'],
                    ['key' => 'entrance_exam_roll_number', 'label' => 'Entrance Exam Roll Number', 'type' => 'text', 'required' => false, 'conditional' => 'entrance_exam_type:not:None'],
                    ['key' => 'entrance_exam_year', 'label' => 'Entrance Exam Year', 'type' => 'number', 'required' => false, 'conditional' => 'entrance_exam_type:not:None'],

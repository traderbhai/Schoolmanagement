...
class PmcTimetableGenerationService
{
    ...
    public function __construct(private PmcTimetableGenerationDiagnosticsService $diagnostics) {}
    ...
    {
        return $this->diagnostics->generationValidationDiagnostics($user, $syncFacultySuitabilityPublishCheck);
    }
}

...
class DepartmentHierarchyService
{
    ...
    private const ROLE_DEPARTMENT_MEMBERSHIPS = [
        ...
        'academic_department_owner' => [['ACAD', 'academic_department_owner']],
        'dean_academics' => [['ACAD', 'dean_academics']],
        'program_chair' => [['ACAD', 'program_director']],
        'hod' => [['ACAD', 'program_leader']],
        'pmc_head' => [['ACAD', 'pmc_head']],
        'pmc_manager' => [['ACAD', 'pmc_manager']],
        'pmc_officer' => [['ACAD', 'pmc_officer']],
        'coe' => [['ACAD', 'coe'], ['EXAM', 'department_owner']],
        'exam_manager' => [['ACAD', 'exam_manager'], ['EXAM', 'department_manager']],
        'exam_officer' => [['ACAD', 'exam_officer'], ['EXAM', 'department_staff']],
        'exam_cell' => [['ACAD', 'coe'], ['EXAM', 'department_owner']],
        'iqac_head' => [['ACAD', 'iqac_head']],
        'iqac_manager' => [['ACAD', 'iqac_manager']],
        'iqac_officer' => [['ACAD', 'iqac_officer']],
        'program_director' => [['ACAD', 'program_director']],
        'program_leader' => [['ACAD', 'program_leader']],
        'semester_coordinator' => [['ACAD', 'semester_coordinator']],
        'course_coordinator' => [['ACAD', 'course_coordinator']],
        'faculty_mentor' => [['ACAD', 'faculty_mentor']],

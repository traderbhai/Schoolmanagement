...
class AcademicPmcV004Service
{
    ...
    public function surfaceMap(): array
    {
        return [
            ...
            'curriculum-governance-v004' => ['title' => 'PMC Deep Curriculum Governance', 'description' => 'Syllabus versions, curriculum approvals, CO/PO mapping, credit checks, and rollout tracking.', 'types' => ['curriculum_rollout', 'syllabus_version', 'curriculum_validation'], 'legacyLinks' => [['label' => 'Curriculum rollout', 'route' => route('academics.pmc.curriculum-rollout.index')], ['label' => 'Syllabus versions', 'route' => route('academics.pmc.syllabus-versions.index')], ['label' => 'Approval cockpit', 'route' => route('academics.pmc.approvals.index')]]],
            ...
            'faculty-allocation-v004' => ['title' => 'PMC Faculty Allocation Governance', 'description' => 'Subject allocation, load balancing, suitability, shortage, and approval workflow.', 'types' => ['faculty_allocation', 'faculty_shortage', 'workload_rule'], 'legacyLinks' => [['label' => 'Faculty allocation', 'route' => route('academics.pmc.faculty-allocation-v004.index')], ['label' => 'Faculty shortage', 'route' => route('academics.pmc.faculty-shortage.index')]]],
            ...
            'timetable-governance' => ['title' => 'PMC Timetable Governance', 'description' => 'Version status, freeze/revision workflow, conflict control, and publish readiness.', 'types' => ['timetable_governance', 'timetable_conflict', 'substitution_control'], 'legacyLinks' => [['label' => 'Timetable planner', 'route' => route('academics.pmc.timetable-planner.index')], ['label' => 'Timetable conflicts', 'route' => route('academics.pmc.timetable-conflicts.index')], ['label' => 'Substitutions', 'route' => route('academics.pmc.substitution-control.index')]]],
            ...
            'course-delivery' => ['title' => 'PMC Course Delivery Control', 'description' => 'Planned vs actual teaching, missed sessions, assessment progress, LMS readiness, and remedial planning.', 'types' => ['course_delivery', 'delivery_risk', 'remedial_plan'], 'legacyLinks' => [['label' => 'Course delivery', 'route' => route('academics.pmc.course-delivery.index')], ['label' => 'Delivery risk', 'route' => route('academics.pmc.delivery-risk.index')], ['label' => 'Remedial planning', 'route' => route('academics.pmc.remedial-planning.index')]]],

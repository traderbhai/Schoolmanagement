...
class AdmissionOperatingDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        app(AdmissionOperatingV036DemoSeeder::class)->seedAssessmentAndCounsellorOps($program, $batch, $admHead, $manager, $counsellor, $officer, $emailTemplate, $panel, $session, $demoApplicants, $leads);
